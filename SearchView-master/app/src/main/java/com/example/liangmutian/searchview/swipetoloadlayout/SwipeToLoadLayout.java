package com.example.liangmutian.searchview.swipetoloadlayout;
...
import com.example.liangmutian.searchview.R;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    private void scrollLoadingMoreToDefault() {
        //mAutoScroller.autoScroll(-0, mLoadMoreCompleteToDefaultScrollingDuration);
        mAutoScroller.autoScroll(-mFooterOffset, 1);
    }

    public void move(){
        //mAutoScroller.autoScroll();

//        removeCallbacks(this);
//        mAutoScroller.mScroller.mmLastY = 0;
//        if (!mAutoScroller.mScroller.mScroller.isFinished()) {
//            mAutoScroller.mScroller. mScroller.forceFinished(true);
//        }
//        mAutoScroller.mScrollermScroller.startScroll(0, 0, 0, yScrolled, duration);
//        mAutoScroller.mScroller.post(this);
//        mAutoScroller.mScrollermRunning = true;
//        mAutoScroller.mScroller.startScroll(0, 0, 0, -1000, mLoadMoreCompleteToDefaultScrollingDuration);
